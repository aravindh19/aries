...
def gameLoop():
    ...
    while not gameExit:
        ...
        while gameOver == True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key != pygame.K_q or event.key != esc:
        ...
        if lead_x >= randomAppleX and lead_x <= randomAppleX + AppleThickness and lead_y >= randomAppleY and lead_y <= randomAppleY + AppleThickness:
